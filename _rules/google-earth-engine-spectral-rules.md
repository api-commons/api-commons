...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Google Earth Engine REST.
layout: rules
...
- description: ''
  ...
  severity: error
rules_file: rules/google-earth-engine-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/google-earth-engine/refs/heads/main/rules/google-earth-engine-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 1
...
source_filename: google-earth-engine-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/google-earth-engine/refs/heads/main/rules/google-earth-engine-spectral-rules.yml
tags:
- Climate
- Earth Observation
- Environmental
