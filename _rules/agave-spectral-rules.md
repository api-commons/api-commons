...
- security
- servers
description: Spectral linting rules defining API design standards and conventions for Agave.
layout: rules
...
- description: API title must be present
  ...
  severity: error
- description: API title must start with "Agave"
  given: $.info.title
...
- description: Every operation must have a summary
  ...
  severity: error
- description: Operation summaries must start with "Agave"
...
- description: Descriptions must not be empty
  ...
  severity: error
rules_file: rules/agave-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/agave/refs/heads/main/rules/agave-spectral-rules.yml
severity_counts:
  error: 14
  hint: 0
  info: 0
...
source_filename: agave-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/agave/refs/heads/main/rules/agave-spectral-rules.yml
tags:
- Accounting
- Construction
- Integration
