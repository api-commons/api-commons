...
rule_count: 28
rules:
- description: API title should include the provider name (Amazon DynamoDB).
  given: $.info
...
- description: Every operation must have a summary.
  ...
  severity: error
- description: Operation summary should begin with the provider name (Amazon DynamoDB).
  given: $.paths[*][get,post,put,patch,delete,head,options]
...
- description: Operations should include examples for better documentation.
  ...
  severity: info
rules_file: rules/amazon-dynamodb-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-dynamodb/refs/heads/main/rules/amazon-dynamodb-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 4
...
source_filename: amazon-dynamodb-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/amazon-dynamodb/refs/heads/main/rules/amazon-dynamodb-spectral-rules.yml
tags:
- Database
- Document Store
- Key-Value
