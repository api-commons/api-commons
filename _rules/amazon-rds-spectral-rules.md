...
- server
- servers
description: Spectral linting rules defining API design standards and conventions for Amazon RDS.
layout: rules
...
- description: DELETE operations should not have a request body
  ...
  severity: warn
rules_file: rules/amazon-rds-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-rds/refs/heads/main/rules/amazon-rds-spectral-rules.yml
severity_counts:
  error: 8
  hint: 0
  info: 1
...
source_filename: amazon-rds-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/amazon-rds/refs/heads/main/rules/amazon-rds-spectral-rules.yml
tags:
- Cloud Databases
- Database Service
- DBaaS
