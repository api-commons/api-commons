...
- servers
- tag
description: Spectral linting rules defining API design standards and conventions for Amazon MSK.
layout: rules
...
- description: Every operation must have a summary.
  ...
  severity: error
- description: Operation summaries must start with 'Amazon MSK'.
...
- description: OperationId should use camelCase.
  ...
  severity: info
rules_file: rules/amazon-msk-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-msk/refs/heads/main/rules/amazon-msk-spectral-rules.yml
severity_counts:
  error: 9
  hint: 0
  info: 4
...
source_filename: amazon-msk-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/amazon-msk/refs/heads/main/rules/amazon-msk-spectral-rules.yml
tags:
- Broadcasting
- Media Processing
- Media
