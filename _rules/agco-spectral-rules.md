...
- security
- servers
description: Spectral linting rules defining API design standards and conventions for agco.
layout: rules
name: agco API Rules
provider_name: agco
provider_slug: agco
...
- description: API title must be present
  ...
  severity: error
- description: API title must start with "AGCO"
  given: $.info.title
...
- description: Every operation must have a summary
  ...
  severity: error
- description: Operation summaries must start with "AGCO"
...
- description: Descriptions must not be empty
  ...
  severity: error
rules_file: rules/agco-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/agco/refs/heads/main/rules/agco-spectral-rules.yml
severity_counts:
  error: 14
  hint: 0
  info: 0
...
source_filename: agco-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/agco/refs/heads/main/rules/agco-spectral-rules.yml
tags:
- Spectral
- Linting
- API Governance
