...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Google Meet.
layout: rules
...
- description: ''
  ...
  severity: error
rules_file: rules/google-meet-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/google-meet/refs/heads/main/rules/google-meet-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 1
...
source_filename: google-meet-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/google-meet/refs/heads/main/rules/google-meet-spectral-rules.yml
tags:
- Google
- Google Workspace
- Meetings
