...
- security
- servers
description: Spectral linting rules defining API design standards and conventions for Amazon Cloud9.
layout: rules
...
rule_count: 19
rules:
- description: API title must start with "Amazon Cloud9"
  given: $.info.title
...
- description: Every operation must have a summary
  ...
  severity: error
- description: Operation summaries must start with "Amazon Cloud9"
...
- description: Operations should have x-microcks-operation extension
  ...
  severity: info
rules_file: rules/amazon-cloud9-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-cloud9/refs/heads/main/rules/amazon-cloud9-spectral-rules.yml
severity_counts:
  error: 12
  hint: 0
  info: 1
...
source_filename: amazon-cloud9-spectral-rules.yml
