...
- description: Servers should reference api.demandbase.com.
  given: $.servers[*].url
  name: demandbase-b2b-data-base-url
  severity: warn
- description: B2B Data API should declare apiKey authentication.
  given: $.components.securitySchemes
  name: demandbase-b2b-data-apikey-auth
  severity: error
- description: B2B Data API should expose /companies.
  given: $.paths
  name: demandbase-b2b-data-companies-resource
  severity: warn
- description: B2B Data API should expose /contacts.
  given: $.paths
  name: demandbase-b2b-data-contacts-resource
  severity: warn
rules_file: rules/demandbase-b2b-data-api-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/demandbase/refs/heads/main/rules/demandbase-b2b-data-api-rules.yml
severity_counts:
  error: 1
  hint: 0
  info: 0
...
source_filename: demandbase-b2b-data-api-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/demandbase/refs/heads/main/rules/demandbase-b2b-data-api-rules.yml
tags:
