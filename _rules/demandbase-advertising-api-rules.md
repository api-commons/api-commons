...
- description: Servers should reference api.demandbase.com.
  given: $.servers[*].url
  name: demandbase-advertising-base-url
  severity: warn
- description: Advertising API should declare apiKey authentication.
  given: $.components.securitySchemes
  name: demandbase-advertising-apikey-auth
  severity: error
- description: Advertising API should expose /campaigns.
  given: $.paths
  name: demandbase-advertising-campaigns-resource
  severity: warn
- description: Advertising API should expose /audiences.
  given: $.paths
  name: demandbase-advertising-audiences-resource
  severity: warn
rules_file: rules/demandbase-advertising-api-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/demandbase/refs/heads/main/rules/demandbase-advertising-api-rules.yml
severity_counts:
  error: 1
  hint: 0
  info: 0
...
source_filename: demandbase-advertising-api-rules.yml
...
source_yaml: "extends:\n  - spectral:oas\nrules:\n  demandbase-advertising-base-url:\n    description: Servers should reference api.demandbase.com.\n    given: $.servers[*].url\n    severity: warn\n    then:\n      function: pattern\n      functionOptions:\n        match: \"demandbase\\\\.com\"\n  demandbase-advertising-apikey-auth:\n    description: Advertising API should declare apiKey authentication.\n    given: $.components.securitySchemes\n    severity: error\n    then:\n      field: apiKeyAuth\n      function: truthy\n  demandbase-advertising-campaigns-resource:\n    description: Advertising API should expose /campaigns.\n    given: $.paths\n    severity: warn\n    then:\n      function: pattern\n      functionOptions:\n        match: \"/campaigns\"\n  demandbase-advertising-audiences-resource:\n    description: Advertising API should expose /audiences.\n    given: $.paths\n    severity: warn\n    then:\n      function: pattern\n      functionOptions:\n        match: \"/audiences\"\
  \n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/demandbase/refs/heads/main/rules/demandbase-advertising-api-rules.yml
tags:
