...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Google Optimize.
layout: rules
...
- description: ''
  ...
  severity: error
rules_file: rules/google-optimize-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/google-optimize/refs/heads/main/rules/google-optimize-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 1
...
source_filename: google-optimize-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/google-optimize/refs/heads/main/rules/google-optimize-spectral-rules.yml
tags:
- A/B Testing
- Analytics
- Deprecated
