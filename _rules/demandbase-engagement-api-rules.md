...
- description: Servers should reference api.demandbase.com.
  given: $.servers[*].url
  name: demandbase-engagement-base-url
  severity: warn
- description: Engagement API should declare apiKey authentication.
  given: $.components.securitySchemes
  name: demandbase-engagement-apikey-auth
  severity: error
- description: Engagement API should expose /accounts/{accountId}/engagement.
  given: $.paths
  name: demandbase-engagement-account-resource
  severity: warn
- description: Engagement API should expose /webhooks.
  given: $.paths
  name: demandbase-engagement-webhooks
  severity: warn
rules_file: rules/demandbase-engagement-api-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/demandbase/refs/heads/main/rules/demandbase-engagement-api-rules.yml
severity_counts:
  error: 1
  hint: 0
  info: 0
...
source_filename: demandbase-engagement-api-rules.yml
source_heading: Spectral Ruleset
source_yaml: "extends:\n  - spectral:oas\nrules:\n  demandbase-engagement-base-url:\n    description: Servers should reference api.demandbase.com.\n    given: $.servers[*].url\n    severity: warn\n    then:\n      function: pattern\n      functionOptions:\n        match: \"demandbase\\\\.com\"\n  demandbase-engagement-apikey-auth:\n    description: Engagement API should declare apiKey authentication.\n    given: $.components.securitySchemes\n    severity: error\n    then:\n      field: apiKeyAuth\n      function: truthy\n  demandbase-engagement-account-resource:\n    description: Engagement API should expose /accounts/{accountId}/engagement.\n    given: $.paths\n    severity: warn\n    then:\n      function: pattern\n      functionOptions:\n        match: \"engagement\"\n  demandbase-engagement-webhooks:\n    description: Engagement API should expose /webhooks.\n    given: $.paths\n    severity: warn\n    then:\n      function: pattern\n      functionOptions:\n        match: \"/webhooks\"\
  \n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/demandbase/refs/heads/main/rules/demandbase-engagement-api-rules.yml
tags:
