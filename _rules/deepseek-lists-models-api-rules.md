...
- description: Servers should reference api.deepseek.com.
  given: $.servers[*].url
  name: deepseek-models-server
  severity: warn
- description: API should expose the /models resource.
  given: $.paths
  name: deepseek-models-path
  severity: error
- description: Operations should declare an operationId.
  given: $.paths[*][*]
  name: deepseek-models-operation-id
  severity: warn
rules_file: rules/deepseek-lists-models-api-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/deepseek/refs/heads/main/rules/deepseek-lists-models-api-rules.yml
severity_counts:
  error: 1
  hint: 0
  info: 0
...
source_filename: deepseek-lists-models-api-rules.yml
source_heading: Spectral Ruleset
source_yaml: "extends:\n  - spectral:oas\nrules:\n  deepseek-models-server:\n    description: Servers should reference api.deepseek.com.\n    given: $.servers[*].url\n    severity: warn\n    then:\n      function: pattern\n      functionOptions:\n        match: \"api.deepseek.com\"\n  deepseek-models-path:\n    description: API should expose the /models resource.\n    given: $.paths\n    severity: error\n    then:\n      function: pattern\n      functionOptions:\n        match: \"/models\"\n  deepseek-models-operation-id:\n    description: Operations should declare an operationId.\n    given: $.paths[*][*]\n    severity: warn\n    then:\n      field: operationId\n      function: truthy\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/deepseek/refs/heads/main/rules/deepseek-lists-models-api-rules.yml
tags:
- AI
