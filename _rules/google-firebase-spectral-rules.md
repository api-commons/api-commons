...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Google Firebase.
layout: rules
...
- description: ''
  ...
  severity: error
rules_file: rules/google-firebase-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/google-firebase/refs/heads/main/rules/google-firebase-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 1
...
source_filename: google-firebase-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/google-firebase/refs/heads/main/rules/google-firebase-spectral-rules.yml
tags:
- Analytics
- Authentication
