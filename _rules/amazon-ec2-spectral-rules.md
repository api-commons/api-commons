...
- tag
- tags
description: Spectral linting rules defining API design standards and conventions for Amazon EC2.
layout: rules
...
rule_count: 28
rules:
- description: API title should include the provider name (Amazon EC2).
  given: $.info
...
- description: Every operation must have a summary.
  ...
  severity: error
- description: Operation summary should begin with the provider name (Amazon EC2).
  given: $.paths[*][get,post,put,patch,delete,head,options]
...
- description: Operations should include examples for better documentation.
  ...
  severity: info
rules_file: rules/amazon-ec2-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-ec2/refs/heads/main/rules/amazon-ec2-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 4
...
source_filename: amazon-ec2-spectral-rules.yml
