...
- security
- servers
description: Spectral linting rules defining API design standards and conventions for ZoomInfo.
layout: rules
...
- description: Operations should have x-microcks-operation
  ...
  severity: info
rules_file: rules/zoominfo-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/zoominfo/refs/heads/main/rules/zoominfo-spectral-rules.yml
severity_counts:
  error: 19
  hint: 0
  info: 1
...
source_filename: zoominfo-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/zoominfo/refs/heads/main/rules/zoominfo-spectral-rules.yml
tags:
- B2B
- B2B Data
- Company Data
