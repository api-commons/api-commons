...
- description: OAuth scopes used by Cognito User Pools should be documented in security schemes.
  ...
  name: cognito-scopes-documented
  severity: info
rules_file: rules/amazon-cognito-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-cognito/refs/heads/main/rules/amazon-cognito-spectral-rules.yml
severity_counts:
  error: 10
  hint: 0
  info: 3
...
source_filename: amazon-cognito-spectral-rules.yml
