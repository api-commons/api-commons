...
source_filename: agent-diff-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/agent-diff/refs/heads/main/rules/agent-diff-spectral-rules.yml
tags:
- API Testing
- AI Agents
- Sandboxing
