...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Azure Logic Apps.
layout: rules
...
rule_count: 15
rules:
- description: API title must start with "Azure Logic Apps"
  given: $.info.title
  name: info-title-format
  severity: warn
- description: Operation summaries must start with "Azure Logic Apps"
...
- description: Security schemes should be defined
  ...
  severity: info
rules_file: rules/azure-logic-apps-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/azure-logic-apps/refs/heads/main/rules/azure-logic-apps-spectral-rules.yml
severity_counts:
  error: 5
  hint: 0
  info: 4
...
source_filename: azure-logic-apps-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/azure-logic-apps/refs/heads/main/rules/azure-logic-apps-spectral-rules.yml
tags:
- Azure
- Integration
- iPaaS
