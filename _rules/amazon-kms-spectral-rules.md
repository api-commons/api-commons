...
- security
- servers
description: Spectral linting rules defining API design standards and conventions for Amazon KMS.
layout: rules
...
rule_count: 16
rules:
- description: API title must start with "Amazon KMS"
  given: $.info.title
...
- description: All operations must have a summary
  ...
  severity: error
- description: Summaries must start with "Amazon KMS"
...
- description: Schema components should have descriptions
  ...
  severity: warn
rules_file: rules/amazon-kms-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-kms/refs/heads/main/rules/amazon-kms-spectral-rules.yml
severity_counts:
  error: 9
  hint: 0
  info: 0
...
source_filename: amazon-kms-spectral-rules.yml
