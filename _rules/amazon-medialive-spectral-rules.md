...
- servers
- tag
description: Spectral linting rules defining API design standards and conventions for Amazon MediaLive.
layout: rules
...
- description: Every operation must have a summary.
  ...
  severity: error
- description: Operation summaries must start with 'Amazon MediaLive'.
...
- description: OperationId should use camelCase.
  ...
  severity: info
rules_file: rules/amazon-medialive-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-medialive/refs/heads/main/rules/amazon-medialive-spectral-rules.yml
severity_counts:
  error: 9
  hint: 0
  info: 4
