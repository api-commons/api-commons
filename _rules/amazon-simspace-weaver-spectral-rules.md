...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Amazon SimSpace Weaver.
layout: rules
...
- description: Tags should use Title Case
  ...
  severity: warn
rules_file: rules/amazon-simspace-weaver-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-simspace-weaver/refs/heads/main/rules/amazon-simspace-weaver-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 1
...
source_filename: amazon-simspace-weaver-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/amazon-simspace-weaver/refs/heads/main/rules/amazon-simspace-weaver-spectral-rules.yml
tags:
- Defense
- Digital Twin
- Simulation
