...
- security
- servers
description: Spectral linting rules defining API design standards and conventions for AgeChecker.Net.
layout: rules
...
- description: Descriptions must not be empty
  ...
  severity: error
rules_file: rules/agechecker-net-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/agechecker-net/refs/heads/main/rules/agechecker-net-spectral-rules.yml
severity_counts:
  error: 14
  hint: 0
  info: 0
...
source_filename: agechecker-net-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/agechecker-net/refs/heads/main/rules/agechecker-net-spectral-rules.yml
tags:
- Age Verification
- Identity
- Compliance
