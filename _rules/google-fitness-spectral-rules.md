...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Google Fit REST.
layout: rules
...
- description: ''
  ...
  severity: error
rules_file: rules/google-fitness-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/google-fitness/refs/heads/main/rules/google-fitness-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 1
...
source_filename: google-fitness-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/google-fitness/refs/heads/main/rules/google-fitness-spectral-rules.yml
tags:
- Activity Tracking
- Fitness
- Google
