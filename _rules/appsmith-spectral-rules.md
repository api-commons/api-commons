...
- schema
- servers
description: Spectral linting rules defining API design standards and conventions for Appsmith.
layout: rules
...
- description: Descriptions must not be empty strings
  ...
  severity: warn
rules_file: rules/appsmith-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/appsmith/refs/heads/main/rules/appsmith-spectral-rules.yml
severity_counts:
  error: 8
  hint: 0
  info: 0
...
source_filename: appsmith-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/appsmith/refs/heads/main/rules/appsmith-spectral-rules.yml
tags:
- Low-Code
- Open Source
- Internal Tools
