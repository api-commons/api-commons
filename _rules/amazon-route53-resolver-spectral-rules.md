...
- server
- servers
description: Spectral linting rules defining API design standards and conventions for Amazon Route 53 Resolver.
layout: rules
...
- description: DELETE operations should not have a request body
  ...
  severity: warn
rules_file: rules/amazon-route53-resolver-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-route53-resolver/refs/heads/main/rules/amazon-route53-resolver-spectral-rules.yml
severity_counts:
  error: 8
  hint: 0
  info: 1
...
source_filename: amazon-route53-resolver-spectral-rules.yml
