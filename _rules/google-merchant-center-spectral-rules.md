...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Google Merchant Center.
layout: rules
...
- description: ''
  ...
  severity: error
rules_file: rules/google-merchant-center-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/google-merchant-center/refs/heads/main/rules/google-merchant-center-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 1
...
source_filename: google-merchant-center-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/google-merchant-center/refs/heads/main/rules/google-merchant-center-spectral-rules.yml
tags:
- E-Commerce
- Google Shopping
- Inventory
