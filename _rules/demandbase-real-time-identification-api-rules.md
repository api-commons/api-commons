...
- description: Servers should reference api.company-target.com or api.demandbase.com.
  given: $.servers[*].url
  name: demandbase-rtid-base-url
  severity: warn
- description: Real-Time Identification API should declare apiKey authentication.
  given: $.components.securitySchemes
  name: demandbase-rtid-apikey-auth
  severity: error
- description: Real-Time Identification API should expose /api/v3/ip.json.
  given: $.paths
  name: demandbase-rtid-ip-resource
  severity: warn
- description: Real-Time Identification API should expose /api/v3/domain.json.
  given: $.paths
  name: demandbase-rtid-domain-resource
  severity: warn
rules_file: rules/demandbase-real-time-identification-api-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/demandbase/refs/heads/main/rules/demandbase-real-time-identification-api-rules.yml
severity_counts:
  error: 1
  hint: 0
  info: 0
...
source_filename: demandbase-real-time-identification-api-rules.yml
...
source_yaml: "extends:\n  - spectral:oas\nrules:\n  demandbase-rtid-base-url:\n    description: Servers should reference api.company-target.com or api.demandbase.com.\n    given: $.servers[*].url\n    severity: warn\n    then:\n      function: pattern\n      functionOptions:\n        match: \"(company-target|demandbase)\\\\.com\"\n  demandbase-rtid-apikey-auth:\n    description: Real-Time Identification API should declare apiKey authentication.\n    given: $.components.securitySchemes\n    severity: error\n    then:\n      field: apiKeyAuth\n      function: truthy\n  demandbase-rtid-ip-resource:\n    description: Real-Time Identification API should expose /api/v3/ip.json.\n    given: $.paths\n    severity: warn\n    then:\n      function: pattern\n      functionOptions:\n        match: \"ip\"\n  demandbase-rtid-domain-resource:\n    description: Real-Time Identification API should expose /api/v3/domain.json.\n    given: $.paths\n    severity: warn\n    then:\n      function: pattern\n  \
  \    functionOptions:\n        match: \"domain\"\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/demandbase/refs/heads/main/rules/demandbase-real-time-identification-api-rules.yml
tags:
