...
- operation
- response
description: Spectral linting rules defining API design standards and conventions for Amazon S3.
layout: rules
...
- description: Descriptions must not be empty
  ...
  severity: error
rules_file: rules/amazon-s3-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-s3/refs/heads/main/rules/amazon-s3-spectral-rules.yml
severity_counts:
  error: 7
  hint: 0
  info: 0
...
source_filename: amazon-s3-spectral-rules.yml
