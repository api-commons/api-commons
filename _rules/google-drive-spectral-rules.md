...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Google Drive.
layout: rules
...
- description: ''
  ...
  severity: error
rules_file: rules/google-drive-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/google-drive/refs/heads/main/rules/google-drive-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 1
...
source_filename: google-drive-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/google-drive/refs/heads/main/rules/google-drive-spectral-rules.yml
tags:
- Cloud Storage
- Collaboration
- Document Management
