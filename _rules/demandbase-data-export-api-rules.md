...
- description: Servers should reference api.demandbase.com.
  given: $.servers[*].url
  name: demandbase-export-base-url
  severity: warn
- description: Data Export API should declare apiKey authentication.
  given: $.components.securitySchemes
  name: demandbase-export-apikey-auth
  severity: error
- description: Export API should expose /export/v1/jobs.
  given: $.paths
  name: demandbase-export-jobs-resource
  severity: warn
rules_file: rules/demandbase-data-export-api-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/demandbase/refs/heads/main/rules/demandbase-data-export-api-rules.yml
severity_counts:
  error: 1
  hint: 0
  info: 0
...
source_filename: demandbase-data-export-api-rules.yml
source_heading: Spectral Ruleset
source_yaml: "extends:\n  - spectral:oas\nrules:\n  demandbase-export-base-url:\n    description: Servers should reference api.demandbase.com.\n    given: $.servers[*].url\n    severity: warn\n    then:\n      function: pattern\n      functionOptions:\n        match: \"demandbase\\\\.com\"\n  demandbase-export-apikey-auth:\n    description: Data Export API should declare apiKey authentication.\n    given: $.components.securitySchemes\n    severity: error\n    then:\n      field: apiKeyAuth\n      function: truthy\n  demandbase-export-jobs-resource:\n    description: Export API should expose /export/v1/jobs.\n    given: $.paths\n    severity: warn\n    then:\n      function: pattern\n      functionOptions:\n        match: \"/export/v1/jobs\"\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/demandbase/refs/heads/main/rules/demandbase-data-export-api-rules.yml
tags:
