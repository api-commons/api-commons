...
- security
- servers
description: Spectral linting rules defining API design standards and conventions for Amazon CloudShell.
layout: rules
...
rule_count: 19
rules:
- description: API title must start with "Amazon CloudShell"
  given: $.info.title
...
- description: Every operation must have a summary
  ...
  severity: error
- description: Operation summaries must start with "Amazon CloudShell"
...
- description: Operations should have x-microcks-operation extension
  ...
  severity: info
rules_file: rules/amazon-cloudshell-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/amazon-cloudshell/refs/heads/main/rules/amazon-cloudshell-spectral-rules.yml
severity_counts:
  error: 12
  hint: 0
  info: 1
...
source_filename: amazon-cloudshell-spectral-rules.yml
source_heading: Spectral Ruleset
source_yaml: "rules:\n  info-title-prefix:\n    description: API title must start with \"Amazon CloudShell\"\n    severity: error\n    given: \"$.info.title\"\n    then:\n      function: pattern\n      functionOptions:\n        match: \"^Amazon CloudShell\"\n  info-description-required:\n    description: Info object must have a description\n    severity: error\n    given: \"$.info\"\n    then:\n      field: description\n      function: truthy\n  info-version-required:\n    description: API must have a version\n    severity: error\n    given: \"$.info\"\n    then:\n      field: version\n      function: truthy\n  servers-required:\n    description: API must define at least one server\n    severity: error\n    given: \"$\"\n    then:\n      field: servers\n      function: truthy\n  servers-https-only:\n    description: All server URLs must use HTTPS\n    severity: error\n    given: \"$.servers[*].url\"\n    then:\n      function: pattern\n      functionOptions:\n        match: \"^https://\"\
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/amazon-cloudshell/refs/heads/main/rules/amazon-cloudshell-spectral-rules.yml
tags:
- CloudShell
- Terminal
- CLI
