...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Google News RSS.
layout: rules
...
- description: ''
  ...
  severity: error
rules_file: rules/google-news-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/google-news/refs/heads/main/rules/google-news-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 1
...
source_filename: google-news-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/google-news/refs/heads/main/rules/google-news-spectral-rules.yml
tags:
- Aggregation
- Google News
- Headlines
