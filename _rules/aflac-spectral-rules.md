...
- security
- servers
description: Spectral linting rules defining API design standards and conventions for aflac.
layout: rules
...
- description: Descriptions must not be empty
  ...
  severity: error
rules_file: rules/aflac-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/aflac/refs/heads/main/rules/aflac-spectral-rules.yml
severity_counts:
  error: 14
  hint: 0
  info: 0
...
source_filename: aflac-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/aflac/refs/heads/main/rules/aflac-spectral-rules.yml
tags:
- Spectral
- Linting
- API Governance
