...
- servers
- tags
description: Spectral linting rules defining API design standards and conventions for Google Nest Smart Device Management.
layout: rules
...
- description: ''
  ...
  severity: error
rules_file: rules/google-nest-spectral-rules.yml
rules_url: https://raw.githubusercontent.com/api-evangelist/google-nest/refs/heads/main/rules/google-nest-spectral-rules.yml
severity_counts:
  error: 11
  hint: 0
  info: 1
...
source_filename: google-nest-spectral-rules.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/google-nest/refs/heads/main/rules/google-nest-spectral-rules.yml
tags:
- Camera
- Device Management
- Doorbell
