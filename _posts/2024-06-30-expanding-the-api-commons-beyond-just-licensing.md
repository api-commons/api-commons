...
- [**Common Schema**](https://apicommons.org/common/) - Producing open source schema for all of the common API buildings indexed using APIs.json.
- [**Community Schema**](https://apicommons.org/community/) - Acknowledging the existing hard work of the community in producing open source schema.
- [**Vendor Overlays**](https://apicommons.org/overlays/) - Building on top of the APIs.json overlay properties to augment API operations in new ways.
- [**Base APIs**](https://apicommons.org/base/) - Establishing a base of the most common APIs that we shouldn’t be reinventing the wheel with.
- [**Blueprints**](https://apicommons.org/blueprints/) - Producing APIs.json blueprints from leading API producers to help establish common patterns.
